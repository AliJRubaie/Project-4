...
public class Parties  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c = db.rawQuery("SELECT * FROM Events where Category='Parties'", null);
        ...
        if (count > 0) {
            ...
            ListView listView = (ListView) findViewById(R.id.parties_list_view);
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Restaurant item = (Restaurant) view.getTag();
                    Intent intent =new Intent(Parties.this,OpenEventActivity.class);
