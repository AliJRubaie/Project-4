...
public class Nightlife extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c = db.rawQuery("SELECT * FROM Events where Category='Nightlife'", null);
        ...
        if (count > 0) {
            ...
            ListView listView = (ListView) findViewById(R.id.nightlife_list_view);
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Restaurant item = (Restaurant) view.getTag();
                    Intent intent =new Intent(Nightlife.this,OpenEventActivity.class);
